<?php $__env->startSection('title', 'Consentimento LGPD'); ?>
    ...
    <div class="col-md-8">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="<?php echo e(route('lgpd.consentimento')); ?>">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ryanfigueredo/Dev/plataforma-educacional/resources/views/lgpd/consentimento.blade.php ENDPATH**/ ?>